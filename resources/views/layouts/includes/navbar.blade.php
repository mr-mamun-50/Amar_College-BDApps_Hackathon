    ...
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body px-0">
                <div class="list-group rounded-0">
                    @foreach ($notifications as $notification)
                        <a href="{{ route('home') . '/#post' . $notification->post_id }}"
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-3">
                                    ...
                                    @else
                                        commented your post
                                    @endif
                                    <span class="mb-0">"{{ substr($post->post_text, 0, 20) }}..."</span>
                                </div>
                                @if ($notification->status == 'unread')
                                    <i class="fas fa-circle fa-2xs text-primary ms-auto ps-2"></i>
                                @endif
                            </div>
                            <div class="text-end small">
                                <small
                                    class="text-muted">{{ date('d F', strtotime($notification->act_time)) . ' at ' . date('h:i A', strtotime($notification->act_time)) }}</small>
                            </div>
                        </a>
                    @endforeach
                </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-white shadow-0" data-bs-dismiss="modal">Close</button>
                <a href="{{ route('notification.mark_as_read') }}" class="btn btn-link">Mark all as read</a>
            </div>
        </div>
    </div>
</div>
