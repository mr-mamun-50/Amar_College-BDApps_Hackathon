        ...
        <div class="col-lg-3 col-md-3 py-md-4 pt-4 scroll">
            ...
            <div class="card mb-4">
                <div class="card-body px-3">
                    <h4 class="card-title text-center">Teachers & Students</h4>
                    <hr>
                                ...
                                <table id="tcr_info_table" class="table table-striped" style="width:100%">
                                    ...
                                    <tbody>
                                        @foreach ($teacher as $item)
                                            <tr>
                                                <th>
                                                    <img src="@if ($item->photo) {{ asset('images/teachers' . '/' . $item->photo) }} @else {{ asset('images/asset_img/user-icon.png') }} @endif"
                                ...
                                <table id="st_info_table" class="table table-striped" style="width:100%">
                                    ...
                                    <tbody>
                                        @foreach ($student as $item)
                                            <tr>
                                                <th>
                                                    <img src="@if ($item->photo) {{ asset('images/students' . '/' . $item->photo) }} @else {{ asset('images/asset_img/user-icon.png') }} @endif"
                                                        alt="" class="rounded-circle"
                                                        style="width: 50px; height: 50px; object-fit: cover;">
                                                </th>
                                                <th>{{ $item->name }}</th>
