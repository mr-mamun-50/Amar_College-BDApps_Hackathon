<aside class="main-sidebar elevation-2 sidebar-primary bg-white">
    ...
    <a href="{{ route('admin.dashboard') }}" class="brand-link navbar-primary">
        ...
        <span class="brand-text font-weight-ligh text-white">Amar College</span>
    </a>
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <li class="nav-item">
                    <a href="" class="nav-link" data-toggle="modal" data-target="#premiumModal">
                        ...
                        <p> Tution Fees <i class="far fa-gem right text-warning"></i></p>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a href="" class="nav-link" data-toggle="modal" data-target="#premiumModal">
                        ...
                        <p> Transports <i class="far fa-gem right text-warning"></i></p>
                    </a>
                </li>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="text-center">
                    <i class="fas fa-gem text-warning" style="font-size: 50px"></i>
                    <h2 class="my-2">Get Premium</h2>
                    <p>Upgrading to Amar College Premium will unlock it.</p>

                    <a href="#" class="btn btn-primary mt-1">UPGRADE</a>
                </div>
